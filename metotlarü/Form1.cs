...
namespace metotlarü
{
    ...
    {  
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sekil1.sekilciz(btnsekil,Color.Red);

            int deger = sekil1.alanHaplama();

            lblsonuc.Text = $"uzun kenar : {sekil1.uzunkenar} ve kısa kenaı {sekil1.kisakenar} olan şekilin alan {deger}";
